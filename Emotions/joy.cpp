...
int main()
{
	...
	while (true)
	{
		...
		int start = siguiente(ledInicio + 7);
		int start2 = siguiente(ledInicio + 8);
		...
		if (etapa == 0)
		{
			...
			everloop_image.leds[start2].red = 100;
			everloop_image.leds[start2].green = 255;
			everloop_image.leds[start2].blue = 0;
		}
		else if (etapa == 1)
		{
			everloop_image.leds[siguiente(start2)].red = 100;
			everloop_image.leds[siguiente(start2)].green = 255;
			everloop_image.leds[siguiente(start2)].blue = 0;
		...
		{
			everloop_image.leds[siguiente(start2 + 1)].red = 100;
			everloop_image.leds[siguiente(start2 + 1)].green = 255;
			everloop_image.leds[siguiente(start2 + 1)].blue = 0;
		...
		{
			everloop_image.leds[siguiente(start2 + 2)].red = 100;
			everloop_image.leds[siguiente(start2 + 2)].green = 255;
			everloop_image.leds[siguiente(start2 + 2)].blue = 0;
		...
		{
			for (int i = anterior(start - 2); i < siguiente(start + 4); i++)
			{
